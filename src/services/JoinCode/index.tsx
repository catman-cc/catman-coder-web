...
export function findAll(keyword: string): Promise<API.Response<ExecutorJoinCode[]>> {
    return get<ExecutorJoinCode[]>(`/api/join-code/all`, { keyword })
}

export function findPage(page: API.Page): Promise<API.Response<API.VPage<ExecutorJoinCode>>> {
...
export function findByJoinCode(code: string): Promise<API.Response<ExecutorJoinCode>> {
...
export function createExecutorJoinCode(): Promise<API.Response<ExecutorJoinCode>> {
    return put<ExecutorJoinCode>(`/api/join-code/create`, {})
}

export function flushJoinCode(joinCode: ExecutorJoinCode): Promise<API.Response<ExecutorJoinCode>> {
    return put<ExecutorJoinCode>(`/api/join-code/flush-join-code`, joinCode)
}

export function save(joinCode: ExecutorJoinCode): Promise<API.Response<ExecutorJoinCode>> {
    return put<ExecutorJoinCode>(`/api/join-code/save`, joinCode)
}


export function fuzzy(query: API.FuzzyQuery): Promise<API.Response<Array<ExecutorJoinCode>>> {
...
export class ExecutorJoinCodeService {
    static findPage(page: API.Page, name?: string, code?: string, key?: string, states?: string[]): Promise<API.Response<API.VPage<ExecutorJoinCode>>> {
        return findPage(page, name, code, key, states)
    }
    ...
    static flushJoinCode(joinCode: ExecutorJoinCode): Promise<API.Response<ExecutorJoinCode>> {
        return flushJoinCode(joinCode)
    }

    static save(joinCode: ExecutorJoinCode): Promise<API.Response<ExecutorJoinCode>> {
        return save(joinCode)
    }

    static fuzzy(query: API.FuzzyQuery): Promise<API.Response<Array<ExecutorJoinCode>>> {
        return fuzzy(query)
    }
}