...
import { TypeDefinitionHierarchialSchema, wrapperTypeDefinitionToSchema } from "@/components/HierarchicalSchema/TypeDefinitionSchemaParse";
...
import { CSSProperties, LegacyRef, useEffect, useMemo, useRef, useState } from "react";
...
export const HierarchicalDnd = (props: {
    ...
    useEffect(() => {
        ...
        new ResizeObserver((entries, observer) => {
            console.log("rect was change", allRef.current?.getBoundingClientRect().width);
    ...
    >({
        ...
        hover(item, monitor) {
            ...
            console.log("tryAddChild", tryAddChild);
            ...
            if (tryAddChild) {
                ...
                if (schmea.canAddChild(props.treeId)) {
                    ...
                    console.log("can add child", oldPid, item, schmea);
                    if (pid === oldPid) {
    ...
    const [{ handlerId: childHandlerId, isOver: childIsOver }, childDrop] = useDrop<
        unknown,
        void,
        DropCollect
    >({
            ...
            >
                ...
                >
                    {<Button
                        ...
                        ref={dragref}
                        style={{
                            visibility: !config.locked && schmea.canDrag(props.treeId) ? "visible" : "hidden"
                        }}
                ...
                <div className={"type-definition-tree-row-right-basic"}>
                    <div className={"type-definition-tree-row-type"}>
                        {selectTypeFactory.render(
                            ...
                            (t) => {
                                schmea.changeType(props.treeId, t)
                            },
                            props.schema.schmea,
                    ...
                    <div className="type-definition-tree-row-required">
                        ...
                        >
                            <IconCN type={schmea.get(props.treeId).required ? "icon-icon_required" : "icon-required1"}
                                onClick={() => {
                                    schmea.change(props.treeId, (td) => {
                                    ...
                                    <Button
                                        ...
                                        icon={
                                            <IconCN
                                                ...
                                                onClick={() => {
                                                    schmea.add(props.treeId, wrapperTypeDefinitionToSchema(DefaultTypeDefinition.create(
                                                        {
                                                            name: "",
                                        ...
                                        <Button
                                            ...
                                            icon={
                                                <IconCN
                                                    ...
                                                    onClick={() => {
                                                        schmea.addBrother(props.treeId, wrapperTypeDefinitionToSchema(DefaultTypeDefinition.create(
                                                            {
                                                                name: "",
                                                                type: ComplexType.ofType("string")
                                                            }
                                        ...
                                        items: [
                                            {
                                                key: "copy",
                                                onClick: () => {
                                                    navigator.clipboard.writeText(JSON.stringify(schmea.toTypeDefinitionSchema(props.treeId)))
                                                        .then(() => {
                                                            message.info("复制成功")
                                                        })
                                                        .catch(() => {
