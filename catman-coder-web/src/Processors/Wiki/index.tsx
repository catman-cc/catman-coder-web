...
import WikiEditor from "@/components/Wiki/LexicalWikiEditor/App";
 ...
 * 创建HTTP触发器
 */
export default class WikiProcessor implements Core.Processor {
    ...
    register(context: Core.ApplicationContext) {
        context.resourceContext?.register("wiki", {
