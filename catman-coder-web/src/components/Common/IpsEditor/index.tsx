...
import { IPAddressType, convertIPAddressType, getIPAddressType, levenshteinDistance, validateIP } from "@/core/common/utils";
...
export const IpAutoComplete = (props: IpAutoCompleteProps) => {
    ...
    const [filtedOptions, setFiltedOptions] = useState<{ key: string; value: string }[]>(presetIps)
