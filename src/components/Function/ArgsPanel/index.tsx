...
import { HierarchicalDnd, createDefaultHierarchicalConfig } from "@/components/TypeDefinitionEditor/dnd";
    ...
    const renderArgs = () => {
        return (
            <div className="function-args-panel-type">
                ...
                <HierarchicalDnd treeId={schema.registry.root} schema={schema} renderChildrenIfPublic
                    config={{
