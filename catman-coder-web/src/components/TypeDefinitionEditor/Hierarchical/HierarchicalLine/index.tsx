...
export const Hierarchical = (props: {
  ...
  const [schmea, setSchema] = useState(
  ...
  return (
    <div className="type-definition-line" ref={setNodeRef}>
      <div className="type-definition-line-info">
        <div className="type-definition-line-drag">
          {schmea.canDrag(props.typeDefinitionId) && (
            <Button
              type="link"
              {...listeners}
              {...attributes}
        ...
        <div className="type-definition-line-tag-group">
          {/* 公开标记 */}
          {schmea.isPublic(props.typeDefinitionId) && (
      ...
      {fold &&
        schmea.renderChild(
          props.typeDefinitionId,
          props.renderChildrenIfPublic
        ) && (
            ...
            >
              {schmea.getChildren(props.typeDefinitionId).map((cid) => {
                return (
                  ...
                  >
                    <Hierarchical
                      typeDefinitionId={cid}
                      schema={schmea.schmea}
