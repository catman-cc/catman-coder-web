...
function getMenuItem(name: string, label: string) {
    return {
        ...
        label: <Space>{label}<SettingOutlined size={11} /></Space>,
        value: name,
    }
}
        ...
        return (
            <div>
                <Menu
                    ...
                    style={{ fontSize: 13 }}
                    activeKey={this.state.type.typeName}
                    defaultSelectedKeys={[this.state.type.typeName]}
                    defaultOpenKeys={[this.state.type.typeName]}
                    mode="inline"
                    items={TypeMenu}
                />
            </div>
