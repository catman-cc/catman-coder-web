import { Base, ID } from "catman-coder-core";
import {
  DownOutlined,
  FrownFilled,
  FrownOutlined,
      ...
      <Tabs
        ...
        items={[
                    ...
                    return (
                      <Tooltip title="新增别名" placement="left">
                        <Button
                          size="small"
                          type="link"
                          icon={<IconCN type="icon-f-add" />}
                          onClick={() => {
                            setMetadata({
                              ...metadata,
                              alias: [
                                "",
                                ...metadata.alias.filter((a) => a !== ""),
                              ],
                            });
                          }}
                        >
          ...
          },
          {
            ...
            children: (
              <div key={`${metadata.id}-labels-list`} className="container">
                {/* <Allotment
