...
import { PeekTypeColor, PeekTypeIcon } from "@/components/TypeDefinition/common";
    ...
    return (
        <div>
            <div className="flex justify-between  toolbar">
                <div className="">
                    <BaseTitle icon={<IconCN type="json" />} show={{
                        id: true,
                        group: true,
                        name: true
                    }}
                        data={props.params as unknown as Core.Base}

                        copyable={false} update={() => { }}
                    />
                </div>
                <div className="">
                    <Button
                    ...
                    [
                        {
                            ...
                            render: (_value, record) => {
                                return <div style={{ color: PeekTypeColor(record.data.type.type.typeName) }}>{record.data.name}</div>
                            },
                        }
                        , {
                            key: "type",
