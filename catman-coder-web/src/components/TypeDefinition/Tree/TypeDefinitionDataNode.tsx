...
export class TypeDefinitionTree {
  ...
  constructor(td?: DefaultTypeDefinition) {
    ...
    td.recursionChildWithCallback(
      (c: DefaultTypeDefinition, p: DefaultTypeDefinition) => {
  ...
  hasChild(
    id: string,
    filter: (_tdId: string, _td: DefaultTypeDefinition) => boolean,
  ): boolean {
    const child = this.relationship[id];
    if (child) {
  ...
  doWitchChild(
    id: string,
    callback: (_cid: string, _td: DefaultTypeDefinition) => void,
  ) {
 ...
 */
export const buildTypeDefinitionDataNode = (
  td: DefaultTypeDefinition,
  belong?: TypeDefinitionData,
): TypeDefinitionDataNode => {
  const data: TypeDefinitionDataNode = {
    className: "",
    key: td.id,
